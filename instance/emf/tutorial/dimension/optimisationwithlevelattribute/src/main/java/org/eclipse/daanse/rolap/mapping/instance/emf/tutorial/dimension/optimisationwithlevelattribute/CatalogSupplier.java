...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        hierarchy1.setSource(joinQuery);
        ...
        catalog.getOwnedElement().addAll(List.of(query, queryH1L1, queryHxL2, joinQuery, h1Level1, h1Level2, hierarchy1, dimension));
        catalog.getOwnedElement().addAll(List.of(cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Dimension optimization with level attributes");
