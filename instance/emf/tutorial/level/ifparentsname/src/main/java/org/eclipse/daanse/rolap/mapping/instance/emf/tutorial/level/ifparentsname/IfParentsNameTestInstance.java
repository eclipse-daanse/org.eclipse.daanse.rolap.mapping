...
public class IfParentsNameTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.level.ifparentsname";
    }
    ...
    public Map<String, URL> csvResources() {
        return new java.util.LinkedHashMap<String, URL>() {{
            ...
            put("Level_2", getClass().getResource("data/Level_2.csv"));
    ...
    public DatabaseSupplier databaseSupplier() {
        return new IfParentsNameDatabaseSupplier();
    }
