...
/**
 * Auto-discovered test instance for tutorial.cube.hierarchy.query.table.base.
 */
public class HierarchyQueryTableBaseTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.hierarchy.query.table.base"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new HierarchyQueryTableBaseDatabaseSupplier();
    }
