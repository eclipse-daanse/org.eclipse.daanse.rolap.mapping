...
public class ExpressionColumnTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.database.expressioncolumn";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new ExpressionColumnDatabaseSupplier();
    }
