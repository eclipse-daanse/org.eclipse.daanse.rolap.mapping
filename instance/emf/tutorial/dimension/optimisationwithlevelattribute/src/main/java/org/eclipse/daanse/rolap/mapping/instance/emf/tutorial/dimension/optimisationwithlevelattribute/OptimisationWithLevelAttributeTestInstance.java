...
public class OptimisationWithLevelAttributeTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.dimension.optimisationwithlevelattribute";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new OptimisationWithLevelAttributeDatabaseSupplier();
    }
