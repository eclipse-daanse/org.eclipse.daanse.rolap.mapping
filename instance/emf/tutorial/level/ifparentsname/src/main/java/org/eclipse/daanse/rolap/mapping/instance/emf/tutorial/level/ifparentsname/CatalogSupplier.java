...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        queryJoin1Left.setSource(queryLevel2);
        ...
        hierarchyDimensionMembersHiddenIfParentsName.setSource(queryJoin);
        ...
        catalog.getOwnedElement().addAll(List.of(queryFact, queryLevel1, queryLevel2, queryJoin, hierarchyDimensionMembersHiddenIfParentsNameLevel1, hierarchyDimensionMembersHiddenIfParentsNameLevel2, hierarchyDimensionMembersHiddenIfParentsName, dimensionMembersHiddenIfParentsName));
        catalog.getOwnedElement().addAll(List.of(cube1));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Level handling parent name references");
