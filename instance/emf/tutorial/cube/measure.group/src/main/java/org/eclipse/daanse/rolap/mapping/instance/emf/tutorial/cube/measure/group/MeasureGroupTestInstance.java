...
/**
 * Auto-discovered test instance for tutorial.cube.measure.group — three
 * measures across two MeasureGroups (Group Alphabetic, Group Other), all
 * three summing to 63 across the same column.
 */
public class MeasureGroupTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.cube.measure.group";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureGroupDatabaseSupplier();
    }
