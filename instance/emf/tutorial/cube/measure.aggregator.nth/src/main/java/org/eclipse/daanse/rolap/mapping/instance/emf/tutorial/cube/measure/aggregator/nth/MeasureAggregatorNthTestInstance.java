...
/**
 * Auto-discovered test instance for tutorial.cube.measure.aggregator.nth.
 */
public class MeasureAggregatorNthTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.measure.aggregator.nth"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureAggregatorNthDatabaseSupplier();
    }
