...
/**
 * Auto-discovered test instance for tutorial.cube.hierarchy.hasall.
 */
public class HierarchyHasAllTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.cube.hierarchy.hasall";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new HierarchyHasAllDatabaseSupplier();
    }
