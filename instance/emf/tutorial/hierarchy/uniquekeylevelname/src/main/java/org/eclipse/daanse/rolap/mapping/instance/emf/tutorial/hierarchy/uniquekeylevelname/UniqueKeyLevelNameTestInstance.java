...
public class UniqueKeyLevelNameTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.hierarchy.uniquekeylevelname";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new UniqueKeyLevelNameDatabaseSupplier();
    }
