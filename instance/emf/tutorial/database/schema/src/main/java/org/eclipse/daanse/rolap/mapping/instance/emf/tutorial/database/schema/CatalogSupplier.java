...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getImportedElement().add(databaseSchemaDefault);
        ...
        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Database schema configuration and organization");
