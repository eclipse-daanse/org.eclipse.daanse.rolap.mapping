 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.cube.differentaggregators;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        schema.setName("01-03_Minimal_Cube_With_One_Measure_And_Different_Aggregators");
        schema.setDescription("Schema of a minimal cube with one measurement column and different aggregators");
        ...
        documentation.setValue("catalog with schema of a minimal cube with one measurement column and different aggregators");
