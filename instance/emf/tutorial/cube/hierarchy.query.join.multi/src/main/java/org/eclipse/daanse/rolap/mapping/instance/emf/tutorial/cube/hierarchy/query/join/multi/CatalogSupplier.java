...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(queryFact, queryLevelTown, queryLevelCountry, queryLevelContinent, queryJoinCountryToContinent, queryJoinTownToCountry, levelTown, levelCounty));
        catalog.getOwnedElement().addAll(List.of(levelContinent, hierarchy, dimension, cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Multi-level hierarchy with joins");
