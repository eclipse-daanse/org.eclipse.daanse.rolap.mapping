...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        joinQueryLeft.setSource(queryTown);
        ...
        joinQueryRight.setSource(queryCountry);
        ...
        hierarchy.setSource(queryHierarchy);
        ...
        catalog.getOwnedElement().addAll(List.of(queryFact, queryTown, queryCountry, queryHierarchy, levelTown, levelCountry, hierarchy, dimension));
        catalog.getOwnedElement().addAll(List.of(cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Measure with inline table and physical table");
