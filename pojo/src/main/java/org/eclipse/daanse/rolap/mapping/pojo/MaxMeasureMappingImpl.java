...
public class MaxMeasureMappingImpl extends MeasureMappingImpl implements MaxMeasureMapping{

    private ColumnMapping column;

    private MaxMeasureMappingImpl(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends MeasureMappingImpl.Builder {
        ...
        public MaxMeasureMappingImpl build() {
            return new MaxMeasureMappingImpl(this);
        }
