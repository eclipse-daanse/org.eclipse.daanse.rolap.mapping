...
/**
 * Provides a check suite for the level expressions tutorial.
 * Checks that the catalog, cube, dimension, hierarchy, levels with SQL expression columns, and measure exist and are accessible.
 */
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        //levelAttributeCheck.setAttributeType(LevelAttribute.LEVEL_TYPE);

        // Create level checks
        LevelCheck level1Check = factory.createLevelCheck();
        level1Check.setName("LevelCheck-Level1");
        level1Check.setDescription("Check that level 'Level1' exists with expression-based name column");
        level1Check.setLevelName("Level1");
        //level1Check.getLevelAttributeChecks().add(levelAttributeCheck);

        LevelCheck level2Check = factory.createLevelCheck();
        level2Check.setName("LevelCheck-Level2");
        level2Check.setDescription("Check that level 'Level2' exists with expression-based column, caption, and ordinal");
        ...
        hierarchyCheck.setDescription("Check that hierarchy 'HierarchyWithHasAll' exists with two levels");
        ...
        databaseSchemaCheck.setDescription("Database Schema Check for Daanse Tutorial - Level Expressions");
        databaseSchemaCheck.getTableChecks().add(databaseTableCheckFact);

        // Create catalog check with cube check
        CatalogCheck catalogCheck = factory.createCatalogCheck();
        catalogCheck.setName("Daanse Tutorial - Level Expressions");
        catalogCheck.setDescription("Check that catalog 'Daanse Tutorial - Level Expressions' exists with expression-based level definitions");
        catalogCheck.setCatalogName("Daanse Tutorial - Level Expressions");
        ...
        connectionCheck.setName("Connection Check Daanse Tutorial - Level Expressions");
        connectionCheck.setDescription("Connection check for Daanse Tutorial - Level Expressions");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Daanse Tutorial - Level Expressions");
        suite.setDescription("Check suite for the Daanse Tutorial - Level Expressions with SQL expression-based columns");
