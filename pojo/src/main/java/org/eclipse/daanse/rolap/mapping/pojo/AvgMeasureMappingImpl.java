...
public class AvgMeasureMappingImpl extends MeasureMappingImpl implements AvgMeasureMapping {

    private ColumnMapping column;

    private AvgMeasureMappingImpl(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends MeasureMappingImpl.Builder {
        ...
        public AvgMeasureMappingImpl build() {
            return new AvgMeasureMappingImpl(this);
        }
    }
}
