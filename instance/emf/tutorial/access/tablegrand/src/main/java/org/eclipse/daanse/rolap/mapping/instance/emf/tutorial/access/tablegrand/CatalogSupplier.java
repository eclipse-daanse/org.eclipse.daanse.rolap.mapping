...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        AccessTableGrant accessTableGrantCustom = DatabaseFactory.eINSTANCE.createAccessTableGrant();
        ...
        AccessDatabaseSchemaGrant accessDatabaseSchemaGrantCustom = DatabaseFactory.eINSTANCE.createAccessDatabaseSchemaGrant();
        ...
        AccessCubeGrant accessCubeGrant3 = OlapFactory.eINSTANCE.createAccessCubeGrant();
        ...
        AccessCatalogGrant accessCatalogGrantCustom = CommonFactory.eINSTANCE.createAccessCatalogGrant();
        ...
        roleCustom = CommonFactory.eINSTANCE.createAccessRole();
        ...
        catalog.getOwnedElement().addAll(List.of(query, cube1, roleAll, roleNone, roleCustom));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Access control with table-level grants");
    ...
    public TutorialDescription describe() {
        return new TutorialDescription(
                List.of(
                        new DocSection("Daanse Tutorial - Access Table Grant", catalogBody, 1, 0, 0, null, 0),
                        ...
                        new DocSection("roleCustom", roleCustomBody, 1, 9, 0, roleCustom, 2)),
