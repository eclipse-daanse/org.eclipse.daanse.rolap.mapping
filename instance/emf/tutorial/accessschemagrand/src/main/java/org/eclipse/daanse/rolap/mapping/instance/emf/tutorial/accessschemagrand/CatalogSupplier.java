...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        schema.setName("Cube_with_access_all_dimension");
        schema.setDescription("Schema with access all dimension only");
        ...
        documentation.setValue("Catalog with schema with access all dimension only");
