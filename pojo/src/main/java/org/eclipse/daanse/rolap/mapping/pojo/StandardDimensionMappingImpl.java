...
public class StandardDimensionMappingImpl extends DimensionMappingImpl implements StandardDimensionMapping {

    private StandardDimensionMappingImpl(Builder builder) {
    ...
    public static final class Builder {
        ...
        public StandardDimensionMappingImpl build() {
            return new StandardDimensionMappingImpl(this);
        }
    }
}
