...
public class WithoutDimensionTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.writeback.withoutdimension";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new WithoutDimensionDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new WithoutDimensionDatabaseSupplier();
    }
