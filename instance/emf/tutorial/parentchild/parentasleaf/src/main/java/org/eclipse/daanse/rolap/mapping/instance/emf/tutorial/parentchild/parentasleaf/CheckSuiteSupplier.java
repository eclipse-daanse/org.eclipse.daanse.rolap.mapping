...
/**
 * Provides a check suite for the parent-child hierarchy with parent as leaf enabled tutorial.
 * Checks that the catalog, cube, measure, and parent-child hierarchy with parentAsLeafEnable exist and are accessible.
 */
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    private static final String CATALOG_NAME = "Daanse Tutorial - Parent Child Parent As Leaf";
    ...
    public OlapCheckSuite get() {
        ...
        cubeCheck.setDescription("Check that cube '" + CUBE_NAME + "' exists with parent-child hierarchy with parent as leaf");
        ...
        catalogCheck.setDescription("Check that catalog '" + CATALOG_NAME + "' exists with parent-child hierarchy with parent as leaf");
        ...
        connectionCheck.setDescription("Connection check for parent-child hierarchy with parent as leaf tutorial");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Parent Child Parent As Leaf Suite");
        suite.setDescription("Check suite for the parent-child hierarchy with parent as leaf mapping tutorial");
