...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(query, query1, level, hierarchy, dimension, cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Minimal parent-child hierarchy");
