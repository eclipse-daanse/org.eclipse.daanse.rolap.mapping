...
/**
 * Provides a check suite for the virtual cube calculated member tutorial.
 * Checks that the catalog with two physical cubes (Cube1, Cube2) and one virtual cube (Cube1Cube2),
 * their measures, calculated members, and dimensions exist and are accessible.
 */
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    private static final String CATALOG_NAME = "Daanse Tutorial - Virtual Cube Calculated Member";
    ...
    // Calculated member names
    private static final String CALC_MEMBER_SUM_CUB1 = "Sum_Cub1";
    private static final String CALC_MEMBER_SUM_CUB2 = "Sum_Cub2";
    private static final String CALC_MEMBER_SUM_CUB = "Sum_Cub";
    ...
    public OlapCheckSuite get() {
        ...
        cubeCheckCube1.getMeasureChecks().add(calcMemberCheckSumCub1);
        ...
        cubeCheckCube2.getMeasureChecks().add(calcMemberCheckSumCub2);
        ...
        connectionCheck.setDescription("Connection check for virtual cube calculated member tutorial");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Virtual Cube Calculated Member Suite");
        suite.setDescription("Check suite for the virtual cube calculated member tutorial");
