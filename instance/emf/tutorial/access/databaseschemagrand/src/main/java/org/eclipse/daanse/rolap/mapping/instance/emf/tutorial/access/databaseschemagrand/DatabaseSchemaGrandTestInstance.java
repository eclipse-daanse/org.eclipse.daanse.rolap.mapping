...
public class DatabaseSchemaGrandTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.access.databaseschemagrand";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new DatabaseSchemaGrandDatabaseSupplier();
    }
