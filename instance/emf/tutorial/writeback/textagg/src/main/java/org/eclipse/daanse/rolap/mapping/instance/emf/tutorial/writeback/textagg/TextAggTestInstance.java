...
public class TextAggTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.writeback.textagg";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new TextAggDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new TextAggDatabaseSupplier();
    }
