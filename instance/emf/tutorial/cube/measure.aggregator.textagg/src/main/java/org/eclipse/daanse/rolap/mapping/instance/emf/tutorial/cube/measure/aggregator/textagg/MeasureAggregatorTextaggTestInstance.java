...
/**
 * Auto-discovered test instance for tutorial.cube.measure.aggregator.textagg.
 */
public class MeasureAggregatorTextaggTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.measure.aggregator.textagg"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureAggregatorTextaggDatabaseSupplier();
    }
