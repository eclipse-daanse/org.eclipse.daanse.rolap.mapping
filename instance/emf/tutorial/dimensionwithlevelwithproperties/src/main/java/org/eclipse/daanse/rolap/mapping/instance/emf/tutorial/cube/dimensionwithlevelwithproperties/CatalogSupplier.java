 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.cube.dimensionwithlevelwithproperties;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        schema.setName("Minimal_Cube_with_cube_dimension_level_with_property");
        schema.setDescription("Schema of a minimal cube with cube dimension level with property");
        ...
        documentation.setValue("Catalog with schema of a minimal cube with cube dimension level with property");
