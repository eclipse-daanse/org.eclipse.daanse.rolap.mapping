...
/**
 * Auto-discovered test instance for tutorial.cube.measure.aggregator.base —
 * one cube ({@code MeasuresAggregatorsCube}) with four base aggregators
 * (Sum=63, Max=42, Min=21, Avg=31.5) over Fact.csv (A=42, B=21).
 */
public class MeasureAggregatorBaseTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.cube.measure.aggregator.base";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureAggregatorBaseDatabaseSupplier();
    }
