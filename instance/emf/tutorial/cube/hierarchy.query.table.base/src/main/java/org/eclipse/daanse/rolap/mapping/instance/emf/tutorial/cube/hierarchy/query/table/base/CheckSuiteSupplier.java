...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        catalogCheck.setName("Daanse Tutorial - Hierarchy Query Table Base");
        catalogCheck.setDescription("Check that catalog 'Daanse Tutorial - Hierarchy Query Table Base' exists with its cubes");
        catalogCheck.setCatalogName("Daanse Tutorial - Hierarchy Query Table Base");
        ...
        connectionCheck.setName("Connection Check Daanse Tutorial - Hierarchy Query Table Base");
        connectionCheck.setDescription("Connection check for Daanse Tutorial - Hierarchy Query Table Base");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Daanse Tutorial - Hierarchy Query Table Base");
        suite.setDescription("Check suite for the Daanse Tutorial - Hierarchy Query Table Base");
