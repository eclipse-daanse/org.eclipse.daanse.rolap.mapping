...
/**
 * Auto-discovered test instance for the complex.accountingonecube catalog.
 ...
 */
public class AccountingOneCubeTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "complex.accountingonecube";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new AccountingOneCubeDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new AccountingOneCubeDatabaseSupplier();
    }
