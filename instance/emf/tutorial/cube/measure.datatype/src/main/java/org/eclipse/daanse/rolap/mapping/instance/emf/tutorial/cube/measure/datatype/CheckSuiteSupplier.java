...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        queryCheck1.setQuery("SELECT [Measures].[Measure - Datatype Integer] ON COLUMNS FROM [MeasuresDatatypeCube]");
        ...
        queryCheck2.setQuery("SELECT [Measures].[Measure - Datatype Numeric] ON COLUMNS FROM [MeasuresDatatypeCube]");
