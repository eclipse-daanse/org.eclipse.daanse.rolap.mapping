 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.measureformats;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    private static final String CATALOG = "tutorial_01-04-04_Cube_Measure_MeasureFormatStrings";
    ...
    public CatalogMapping get() {
        ...
        schema.setName("Minimal_Cube_With_Measures_Of_Different_formats");
        schema.setDescription("Schema of a minimal cube containing the same measurement with two different formats");
        ...
        documentation.setValue(
                "Catalog with schema of a minimal cube containing the same measurement with two different formats");
