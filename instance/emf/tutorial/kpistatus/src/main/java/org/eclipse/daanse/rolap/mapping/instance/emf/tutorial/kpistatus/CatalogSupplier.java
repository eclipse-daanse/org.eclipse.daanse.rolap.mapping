 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.kpistatus;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    private static final String CATALOG = "tutorial_30-04_Cube_KPI_with_Status";
    ...
    public CatalogMapping get() {
        ...
        kpi.setName("Kpi1");
        kpi.setId("Kpi1");
        kpi.setDescription("Kpi with Status parameter");
        ...
        schema.setName("Minimal_Cubes_With_KPI_Status");
        schema.setDescription("Minimal Cubes With KPI with Status property");
        ...
        documentation.setValue("Catalog with schema with a minimal cubes With KPI with Status property");
