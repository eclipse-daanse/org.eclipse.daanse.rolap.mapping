...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    private DatabaseSchemaCheck createDatabaseSchemaCheck() {
        ...
        schemaCheck.setName("Daanse Tutorial - Access With Default Role Database Schema Check");
        schemaCheck.setDescription("Verify database tables and columns exist for Daanse Tutorial - Access With Default Role");
    ...
    private CubeCheck createCubeCheck() {
        ...
        cubeCheck.setName("Daanse Tutorial - Access With Default Role Cube Check");
        cubeCheck.setDescription("Verify Daanse Tutorial - Access With Default Role cube structure with all dimensions and measures");
