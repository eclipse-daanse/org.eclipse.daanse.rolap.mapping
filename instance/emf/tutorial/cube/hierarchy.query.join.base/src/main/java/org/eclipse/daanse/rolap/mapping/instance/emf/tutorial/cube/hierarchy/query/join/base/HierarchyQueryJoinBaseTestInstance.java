...
/**
 * Auto-discovered test instance for tutorial.cube.hierarchy.query.join.base.
 */
public class HierarchyQueryJoinBaseTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.hierarchy.query.join.base"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new HierarchyQueryJoinBaseDatabaseSupplier();
    }
