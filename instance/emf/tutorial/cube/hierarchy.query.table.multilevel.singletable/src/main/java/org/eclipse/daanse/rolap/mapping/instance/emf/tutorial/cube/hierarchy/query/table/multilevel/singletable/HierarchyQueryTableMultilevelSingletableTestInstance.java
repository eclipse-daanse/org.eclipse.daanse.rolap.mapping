...
/**
 * Auto-discovered test instance for tutorial.cube.hierarchy.query.table.multilevel.singletable.
 */
public class HierarchyQueryTableMultilevelSingletableTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.hierarchy.query.table.multilevel.singletable"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new HierarchyQueryTableMultilevelSingletableDatabaseSupplier();
    }
