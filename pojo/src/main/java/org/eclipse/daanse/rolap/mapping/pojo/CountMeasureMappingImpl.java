...
public class CountMeasureMappingImpl extends MeasureMappingImpl implements CountMeasureMapping {

    private ColumnMapping column;
    private boolean distinct;

    private CountMeasureMappingImpl(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends MeasureMappingImpl.Builder {
        ...
        public CountMeasureMappingImpl build() {
            return new CountMeasureMappingImpl(this);
        }
    }
