 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.cube.dimensionwithlevelwithparentchild;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        table.setName(FACT);
        table.setId(FACT);
        table.getColumns().addAll(List.of(employeeIdColumn, fullNameColumn, supervisorIdColumn,
                maritalStatusColumn, positionTitleColumn,genderColumn,salaryColumn,educationLevelColumn,managementRoleColumn));
        ...
        employeeClosureTable.getColumns().addAll(List.of(employeeClosureSupervisorIdColumn, employeeClosureEmployeeIdColumn,
                employeeClosureDistanceColumn));
        ...
        level.getMemberProperties().addAll(List.of(propMaritalStatus, propPositionTitle, propGender,
                propSalary, propEducationLevel, propManagementRole));
