 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.cube.aggregatetables;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        productClassTable.getColumns().addAll(List.of(productClassProductClassIdColumn, productClassProductFamileColumn));
        ...
        productClassTable.getColumns().addAll(List.of(aggCSpecialSalesFact1997ProductIdColumn, aggCSpecialSalesFact1997StoreCostSumColumn, aggCSpecialSalesFact1997FactCountColumn));
        ...
        schema.setName("Cube_with_Aggregate_tables");
        schema.setDescription("Schema with aggregate tables");
