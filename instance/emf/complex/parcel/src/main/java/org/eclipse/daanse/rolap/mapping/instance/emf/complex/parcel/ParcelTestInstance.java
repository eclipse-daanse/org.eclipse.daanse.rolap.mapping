...
/**
 * Auto-discovered test instance for the complex.parcel catalog.
 ...
 */
public class ParcelTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "complex.parcel";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new ParcelDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new ParcelDatabaseSupplier();
    }
