...
public class DecimalAndCommentAndMultiDimTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.writeback.decimalandcommentandmultidim";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new DecimalAndCommentAndMultiDimDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new DecimalAndCommentAndMultiDimDatabaseSupplier();
    }
