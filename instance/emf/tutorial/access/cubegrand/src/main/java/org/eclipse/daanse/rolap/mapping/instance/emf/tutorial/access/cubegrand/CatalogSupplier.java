...
@MappingInstance(kind = Kind.TUTORIAL, number = "2.4.5", source = Source.EMF, group = "Access") // NOSONAR
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        dimensionConnectorCube11.setId("_dc_dimension11");
        ...
        dimensionConnectorCube12.setId("_dc_dimension12");
        ...
        dimensionConnectorCube2.setId("_dc_dimension1");
        ...
        catalog.setName("Cube with role CubeGrant");
        catalog.setDescription("Schema with CubeGrant with cube1 access only");
        ...
        document(catalog, "Cube with role CubeGrant cube1 access only", catalogBody, 1, 0, 0, false, 0);
        ...
        document(cube2, "Cube2 with access none", cube2Body, 1, 7, 0, true, 2);
