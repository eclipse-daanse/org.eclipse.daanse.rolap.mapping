...
/**
 * Auto-discovered test instance for the complex.expressivenames catalog.
 ...
 */
public class ExpressiveNamesTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "complex.expressivenames";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new ExpressiveNamesDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new ExpressiveNamesDatabaseSupplier();
    }
