...
/**
 * Auto-discovered test instance for tutorial.cube.hierarchy.query.join.multi.
 */
public class HierarchyQueryJoinMultiTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.hierarchy.query.join.multi"; }
    ...
    public Map<String, URL> csvResources() {
        return Map.of(
                "Continent", getClass().getResource("data/Continent.csv"),
    ...
    public DatabaseSupplier databaseSupplier() {
        return new HierarchyQueryJoinMultiDatabaseSupplier();
    }
