...
import org.eclipse.daanse.rolap.mapping.model.AccessCatalogGrantMapping;
import org.eclipse.daanse.rolap.mapping.model.AccessCubeGrantMapping;
import org.eclipse.daanse.rolap.mapping.model.AccessDimensionGrantMapping;
import org.eclipse.daanse.rolap.mapping.model.AccessHierarchyGrantMapping;
import org.eclipse.daanse.rolap.mapping.model.AccessMemberGrantMapping;
import org.eclipse.daanse.rolap.mapping.model.AccessRoleMapping;
import org.eclipse.daanse.rolap.mapping.model.ActionMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationColumnNameMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationExcludeMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationForeignKeyMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationLevelMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationLevelPropertyMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationMeasureFactCountMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationNameMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationPatternMapping;
import org.eclipse.daanse.rolap.mapping.model.AggregationTableMapping;
import org.eclipse.daanse.rolap.mapping.model.AnnotationMapping;
import org.eclipse.daanse.rolap.mapping.model.AvgMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.BitAggMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.CalculatedMemberMapping;
import org.eclipse.daanse.rolap.mapping.model.CalculatedMemberPropertyMapping;
import org.eclipse.daanse.rolap.mapping.model.CatalogMapping;
import org.eclipse.daanse.rolap.mapping.model.CellFormatterMapping;
import org.eclipse.daanse.rolap.mapping.model.ColumnMapping;
import org.eclipse.daanse.rolap.mapping.model.ColumnMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.CountMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.CubeConnectorMapping;
import org.eclipse.daanse.rolap.mapping.model.CubeMapping;
import org.eclipse.daanse.rolap.mapping.model.CustomMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.DatabaseCatalogMapping;
import org.eclipse.daanse.rolap.mapping.model.DatabaseSchemaMapping;
import org.eclipse.daanse.rolap.mapping.model.DimensionConnectorMapping;
import org.eclipse.daanse.rolap.mapping.model.DimensionMapping;
import org.eclipse.daanse.rolap.mapping.model.DrillThroughActionMapping;
import org.eclipse.daanse.rolap.mapping.model.DrillThroughAttributeMapping;
import org.eclipse.daanse.rolap.mapping.model.ExplicitHierarchyMapping;
import org.eclipse.daanse.rolap.mapping.model.FormatterMapping;
import org.eclipse.daanse.rolap.mapping.model.HierarchyMapping;
import org.eclipse.daanse.rolap.mapping.model.InlineTableMapping;
import org.eclipse.daanse.rolap.mapping.model.InlineTableQueryMapping;
import org.eclipse.daanse.rolap.mapping.model.JoinQueryMapping;
import org.eclipse.daanse.rolap.mapping.model.JoinedQueryElementMapping;
import org.eclipse.daanse.rolap.mapping.model.KpiMapping;
import org.eclipse.daanse.rolap.mapping.model.LevelMapping;
import org.eclipse.daanse.rolap.mapping.model.LinkMapping;
import org.eclipse.daanse.rolap.mapping.model.MaxMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.MeasureGroupMapping;
import org.eclipse.daanse.rolap.mapping.model.MeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.MemberFormatterMapping;
import org.eclipse.daanse.rolap.mapping.model.MemberMapping;
import org.eclipse.daanse.rolap.mapping.model.MemberPropertyFormatterMapping;
import org.eclipse.daanse.rolap.mapping.model.MemberPropertyMapping;
import org.eclipse.daanse.rolap.mapping.model.MemberReaderParameterMapping;
import org.eclipse.daanse.rolap.mapping.model.MinMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.NamedSetMapping;
import org.eclipse.daanse.rolap.mapping.model.NoneMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.NthAggMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.OrderedColumnMapping;
import org.eclipse.daanse.rolap.mapping.model.ParameterMapping;
import org.eclipse.daanse.rolap.mapping.model.ParentChildHierarchyMapping;
import org.eclipse.daanse.rolap.mapping.model.ParentChildLinkMapping;
import org.eclipse.daanse.rolap.mapping.model.PercentileMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.PhysicalCubeMapping;
import org.eclipse.daanse.rolap.mapping.model.PhysicalTableMapping;
import org.eclipse.daanse.rolap.mapping.model.QueryMapping;
import org.eclipse.daanse.rolap.mapping.model.RowMapping;
import org.eclipse.daanse.rolap.mapping.model.RowValueMapping;
import org.eclipse.daanse.rolap.mapping.model.SQLExpressionColumnMapping;
import org.eclipse.daanse.rolap.mapping.model.SqlExpressionMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.SqlSelectQueryMapping;
import org.eclipse.daanse.rolap.mapping.model.SqlStatementMapping;
import org.eclipse.daanse.rolap.mapping.model.SqlViewMapping;
import org.eclipse.daanse.rolap.mapping.model.StandardDimensionMapping;
import org.eclipse.daanse.rolap.mapping.model.SumMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.SystemTableMapping;
import org.eclipse.daanse.rolap.mapping.model.TableMapping;
import org.eclipse.daanse.rolap.mapping.model.TableQueryMapping;
import org.eclipse.daanse.rolap.mapping.model.TableQueryOptimizationHintMapping;
import org.eclipse.daanse.rolap.mapping.model.TextAggMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.TimeDimensionMapping;
import org.eclipse.daanse.rolap.mapping.model.TranslationMapping;
import org.eclipse.daanse.rolap.mapping.model.ViewTableMapping;
import org.eclipse.daanse.rolap.mapping.model.VirtualCubeMapping;
import org.eclipse.daanse.rolap.mapping.model.WritebackAttributeMapping;
import org.eclipse.daanse.rolap.mapping.model.WritebackMeasureMapping;
import org.eclipse.daanse.rolap.mapping.model.WritebackTableMapping;
import org.eclipse.daanse.rolap.mapping.model.enums.AccessCatalog;
import org.eclipse.daanse.rolap.mapping.model.enums.AccessCube;
import org.eclipse.daanse.rolap.mapping.model.enums.AccessDimension;
import org.eclipse.daanse.rolap.mapping.model.enums.AccessHierarchy;
import org.eclipse.daanse.rolap.mapping.model.enums.AccessMember;
import org.eclipse.daanse.rolap.mapping.model.enums.BitAggregationType;
import org.eclipse.daanse.rolap.mapping.model.enums.ColumnDataType;
import org.eclipse.daanse.rolap.mapping.model.enums.HideMemberIfType;
import org.eclipse.daanse.rolap.mapping.model.enums.InternalDataType;
...
public abstract class AbstractMappingModifier implements CatalogMappingSupplier {
    ...
    protected Catalog modifiedCatalog = null;
    ...
    protected HierarchyMapping hierarchy(HierarchyMapping hierarchy) {
        if (hierarchy != null) {
            if (!hierarchyMap.containsKey(hierarchy)) {
                ...
                HierarchyMapping h = null;
                if (hierarchy instanceof ExplicitHierarchyMapping eh) {
                    List<? extends LevelMapping> levels = explicitHierarchyLevels(eh);
                    h = createExplicitHierarchy(annotations, id, description, name, levels,
                ...
                if (hierarchy instanceof ParentChildHierarchyMapping pch) {
                    LevelMapping level = parentChildHierarchyLevel(pch);
                    ParentChildLinkMapping parentChildLink = parentChildHierarchyParentChildLink(pch);
                    String nullParentValue = parentChildHierarchyNullParentValue(pch);
                    ColumnMapping parentColumn = parentChildHierarchyParentColumn(pch);
                    boolean parentAsLeafEnable = parentChildHierarchyParentAsLeafEnable(pch);
                    String parentAsLeafNameFormat = parentChildHierarchyParentAsLeafNameFormat(pch);

                    h = createParentChildHierarchy(annotations, id, description, name,
                            memberReaderParameters,
                            allLevelName, allMemberCaption, allMemberName, defaultMember, displayFolder, hasAll,
                            memberReaderClass, origin, primaryKey, uniqueKeyLevelName, visible, query, level,
                            parentChildLink, nullParentValue, parentColumn, parentAsLeafEnable, parentAsLeafNameFormat
                            );
                    hierarchyMap.put(hierarchy, h);
    ...
    private LevelMapping parentChildHierarchyLevel(ParentChildHierarchyMapping pch) {
        return level(pch.getLevel());
    }

    protected abstract HierarchyMapping createParentChildHierarchy(List<? extends AnnotationMapping> annotations,
    ...
    protected List<? extends LevelMapping> explicitHierarchyLevels(ExplicitHierarchyMapping hierarchy) {
    ...
    protected abstract HierarchyMapping createExplicitHierarchy(
        List<? extends AnnotationMapping> annotations, String id,
    ...
    protected LevelMapping level(LevelMapping level) {
        if (level != null) {
            if (!levelMap.containsKey(level)) {
                ...
                return createLevel( memberProperties, memberFormatter, approxRowCount,
                    captionColumn, column, hideMemberIf, levelType, nameColumn, ordinalColumn,
                    type, uniqueMembers, visible, name, id, description);
            } else {
    ...
    private boolean parentChildHierarchyParentAsLeafEnable(ParentChildHierarchyMapping hierarchy) {
        return hierarchy.isParentAsLeafEnable();
    }

    private String parentChildHierarchyParentAsLeafNameFormat(ParentChildHierarchyMapping hierarchy) {
        return hierarchy.getParentAsLeafNameFormat();
    }
    ...
    protected ColumnMapping parentChildHierarchyParentColumn(ParentChildHierarchyMapping hierarchy) {
        return column(hierarchy.getParentColumn());
    }
    ...
    protected String parentChildHierarchyNullParentValue(ParentChildHierarchyMapping hierarchy) {
        return hierarchy.getNullParentValue();
    }
    ...
    protected ParentChildLinkMapping parentChildHierarchyParentChildLink(ParentChildHierarchyMapping hierarchy) {
        return parentChildLink(hierarchy.getParentChildLink());
    }
