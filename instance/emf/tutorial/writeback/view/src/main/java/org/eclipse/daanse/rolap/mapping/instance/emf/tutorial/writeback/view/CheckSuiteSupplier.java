...
/**
 * Provides a check suite for the writeback view tutorial.
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    private static final String CATALOG_NAME = "Daanse Tutorial - Writeback View";
    ...
    public OlapCheckSuite get() {
        ...
        // Create database table and column checks for FACT sql view
        //TODO need check for inner tables
        ...
        databaseSchemaCheck.setDescription("Database Schema Check for writeback view tutorial");
        ...
        connectionCheck.setDescription("Connection check for writeback view tutorial");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Writeback View Suite");
        suite.setDescription("Check suite for the writeback view tutorial");
