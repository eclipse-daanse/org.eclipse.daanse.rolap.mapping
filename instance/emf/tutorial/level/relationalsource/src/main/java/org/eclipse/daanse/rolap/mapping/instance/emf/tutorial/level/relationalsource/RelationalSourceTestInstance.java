...
public class RelationalSourceTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.level.relationalsource";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new RelationalSourceDatabaseSupplier();
    }
