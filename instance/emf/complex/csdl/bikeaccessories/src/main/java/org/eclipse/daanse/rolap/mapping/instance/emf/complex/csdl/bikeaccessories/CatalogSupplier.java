...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    @Override
    public Catalog get() {
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_CUSTOMER_ROW_NUMBER, LEVEL_CUSTOMER_CUSTOMER_KEY, LEVEL_CUSTOMER_CUSTOMER_ALTERNATE_KEY, LEVEL_CUSTOMER_FIRST_NAME, LEVEL_CUSTOMER_MIDDLE_NAME, LEVEL_CUSTOMER_LAST_NAME, LEVEL_CUSTOMER_NAME_STYLE, LEVEL_CUSTOMER_BIRTH_DATE));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_CUSTOMER_MARITAL_STATUS, LEVEL_CUSTOMER_SUFFIX, LEVEL_CUSTOMER_GENDER, LEVEL_CUSTOMER_EMAIL_ADDRESS, LEVEL_CUSTOMER_YARLY_INCOME, LEVEL_CUSTOMER_TOTAL_CHILDREN, LEVEL_CUSTOMER_NUMBER_CHILDREN_AT_HOME, LEVEL_CUSTOMER_ENGLISH_EDUCATION));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_CUSTOMER_SPANISH_EDUCATION, LEVEL_CUSTOMER_FRENCH_EDUCATION, LEVEL_CUSTOMER_ENGLISH_OCCUPATION, LEVEL_CUSTOMER_SPANISH_OCCUPATION, LEVEL_CUSTOMER_FRENCH_OCCUPATION, LEVEL_CUSTOMER_HOUSE_OWNER_FLAG, LEVEL_CUSTOMER_NUMBER_CARS_OWNED_FLAG, LEVEL_CUSTOMER_ADDRESS_LINE1));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_CUSTOMER_ADDRESS_LINE2, LEVEL_CUSTOMER_PHONE, LEVEL_CUSTOMER_DATE_FIRST_PURCHASE, LEVEL_CUSTOMER_COMMUTE_DISTANCE, LEVEL_EMPLOYEE_ROW_NUMBER, LEVEL_EMPLOYEE_EMPLOYEE_KEY, LEVEL_EMPLOYEE_PARENT_EMPLOYEE_KEY, LEVEL_EMPLOYEE_EMPLOYEE_NATIONAL_ID_ALTERNATE_KEY));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_EMPLOYEE_PARENT_EMPLOYEE_NATIONAL_ID_ALTERNATE_KEY, LEVEL_EMPLOYEE_SALES_TERRITORY_KEY, LEVEL_EMPLOYEE_FIRST_NAME, LEVEL_EMPLOYEE_LAST_NAME, LEVEL_EMPLOYEE_MIDDLE_NAME, LEVEL_EMPLOYEE_NAME_STYLE, LEVEL_EMPLOYEE_TITLE, LEVEL_EMPLOYEE_HIRE_DATE));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_EMPLOYEE_BIRTH_DATE, LEVEL_EMPLOYEE_LOGIN_ID, LEVEL_EMPLOYEE_EMAIL_ADDRESS, LEVEL_EMPLOYEE_PHONE, LEVEL_EMPLOYEE_MARITAL_STATUS, LEVEL_EMPLOYEE_EMERGENCY_CONTACT_NAME, LEVEL_EMPLOYEE_EMERGENCY_CONTACT_PHONE, LEVEL_EMPLOYEE_SALARIED_FLAG));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_EMPLOYEE_GENDER, LEVEL_EMPLOYEE_PAY_FREQUENCY, LEVEL_EMPLOYEE_BASE_RATE, LEVEL_EMPLOYEE_VACATION_HOURS, LEVEL_EMPLOYEE_SICK_LEAVE_HOURS, LEVEL_EMPLOYEE_CURRENT_FLAG, LEVEL_EMPLOYEE_SALES_PERSONE_FLAG, LEVEL_EMPLOYEE_DEPARTAMENT_NAME));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_EMPLOYEE_START_DATE, LEVEL_EMPLOYEE_END_DATE, LEVEL_EMPLOYEE_STATUS, LEVEL_GEOGRAPHY_ROW_NUMBER, LEVEL_GEOGRAPHY_GEOGRAPHY_KEY, LEVEL_GEOGRAPHY_CITY, LEVEL_GEOGRAPHY_STATE_PROVINCE_CODE, LEVEL_GEOGRAPHY_STATE_PROVINCE_NAME));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_GEOGRAPHY_COUNTRY_REGION_CODE, LEVEL_GEOGRAPHY_ENGLISH_COUNTRY_REGION_NAME, LEVEL_GEOGRAPHY_SPANISH_COUNTRY_REGION_NAME, LEVEL_GEOGRAPHY_FRENCH_COUNTRY_REGION_NAME, LEVEL_GEOGRAPHY_POSTAL_CODE, LEVEL_GEOGRAPHY_SALES_TERRITORY_KEY, LEVEL_STORE_ROW_NUMBER, LEVEL_STORE_STORE_KEY));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_STORE_GEOGRAPHY_KEY, LEVEL_STORE_STORE_NAME, LEVEL_STORE_NUMBER_OF_EMPLOYEES, LEVEL_STORE_SALES, LEVEL_TIME_ROW_NUMBER, LEVEL_TIME_TIME_KEY, LEVEL_TIME_FULL_DATE_ALTERNATE_KEY, LEVEL_TIME_DAY_NUMBER_OF_WEEK));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_TIME_ENGLISH_DAY_NAME_OF_WEEK, LEVEL_TIME_SPANISH_DAY_NAME_OF_WEEK, LEVEL_TIME_FRENCH_DAY_NAME_OF_WEEK, LEVEL_TIME_DAY_NUMBER_OF_MONTH, LEVEL_TIME_DAY_NUMBER_OF_YEAR, LEVEL_TIME_WEEK_NUMBER_OF_YEAR, LEVEL_TIME_ENGLISH_MONTH_NAME, LEVEL_TIME_SPANISH_MONTH_NAME));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_TIME_FRENCH_MONTH_NAME, LEVEL_TIME_MONTH_NUMBER_OF_YEAR, LEVEL_TIME_CALENDAR_QUARTER, LEVEL_TIME_CALENDAR_YEAR, LEVEL_TIME_CALENDAR_SEMESTER, LEVEL_TIME_FISCAL_QUARTER, LEVEL_TIME_FISCAL_YEAR, LEVEL_TIME_FISCAL_SEMESTER));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_PRODUCT_ROW_NUMBER, LEVEL_PRODUCT_PRODUCT_KEY, LEVEL_PRODUCT_PRODUCT_ALTERNATE_KEY, LEVEL_PRODUCT_PRODUCT_SUBCATEGORY_KEY, LEVEL_PRODUCT_WEIGHT_UNIT_MEASURE_CODE, LEVEL_PRODUCT_SIZE_UNIT_MEASURE_CODE, LEVEL_PRODUCT_ENGLISH_PRODUCT_NAME, LEVEL_PRODUCT_SPANISH_PRODUCT_NAME));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_PRODUCT_FRENCH_PRODUCT_NAME, LEVEL_PRODUCT_STANDART_COST, LEVEL_PRODUCT_FINISH_GOODS_FLAG, LEVEL_PRODUCT_COLOR, LEVEL_PRODUCT_SAFETY_STOCK_LEVEL, LEVEL_PRODUCT_REORDER_POINT, LEVEL_PRODUCT_LIST_PRICE, LEVEL_PRODUCT_SIZE));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_PRODUCT_SIZE_RANGE, LEVEL_PRODUCT_WEIGHT, LEVEL_PRODUCT_DAYS_TO_MANUFACTURE, LEVEL_PRODUCT_PRODUCT_LINE, LEVEL_PRODUCT_DEALER_PRICE, LEVEL_PRODUCT_CLASS, LEVEL_PRODUCT_STYLE, LEVEL_PRODUCT_MODEL_NAME));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_PRODUCT_ENGLISH_DESCRIPTION, LEVEL_PRODUCT_FRENCH_DESCRIPTION, LEVEL_PRODUCT_CHINESE_DESCRIPTION, LEVEL_PRODUCT_ARABIC_DESCRIPTION, LEVEL_PRODUCT_HEBREW_DESCRIPTION, LEVEL_PRODUCT_THAI_DESCRIPTION, LEVEL_PRODUCT_START_DATE, LEVEL_PRODUCT_END_DATE));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_PRODUCT_STATUS, LEVEL_PRODUCT_SUBCATEGORY, LEVEL_PRODUCT_CATEGORY_ROW_NUMBER, LEVEL_PRODUCT_CATEGORY_PRODUCT_CATEGORY_KEY, LEVEL_PRODUCT_CATEGORY_PRODUCT_ALTERNATE_KEY, LEVEL_PRODUCT_CATEGORY_ENGLISH_PRODUCT_CATEGORY_NAME, LEVEL_PRODUCT_CATEGORY_SPANISH_PRODUCT_CATEGORY_NAME, LEVEL_PRODUCT_CATEGORY_FINISH_PRODUCT_CATEGORY_NAME));
        CATALOG.getOwnedElement().addAll(List.of(LEVEL_PRODUCT_SUBCATEGORY_ROW_NUMBER, LEVEL_PRODUCT_SUBCATEGORY_PRODUCT_SUBCATEGORY_KEY, LEVEL_PRODUCT_SUBCATEGORY_PRODUCT_ALTERNATE_KEY, LEVEL_PRODUCT_SUBCATEGORY_ENGLISH_PRODUCT_SUBCATEGORY_NAME, LEVEL_PRODUCT_SUBCATEGORY_SPANISH_PRODUCT_SUBCATEGORY_NAME, LEVEL_PRODUCT_SUBCATEGORY_FINISH_PRODUCT_SUBCATEGORY_NAME, LEVEL_PRODUCT_SUBCATEGORY_PRODUCT_CATEGORY_KEY, TABLESOURCE_FACT));
        CATALOG.getOwnedElement().addAll(List.of(TABLESOURCE_CUSTOMER, TABLESOURCE_EMPLOYEE, TABLESOURCE_GEOGRAPHY, TABLESOURCE_PRODUCT, TABLESOURCE_PRODUCT_CATEGORY, TABLESOURCE_PRODUCT_SUBCATEGORY, TABLESOURCE_STORE, TABLESOURCE_TIME));
        CATALOG.getOwnedElement().addAll(List.of(JOIN_GEOGRAPHY, JOIN_SUBCATEGORY_CATEGORY, JOIN_PRODUCT_CATEGORY, JOIN_PRODUCT_SUBCATEGORY, HIERARCHY_CUSTOMER, HIERARCHY_EMPLOYEE, HIERARCHY_GEOGRAPHY, HIERARCHY_PRODUCT));
        CATALOG.getOwnedElement().addAll(List.of(HIERARCHY_PRODUCT_CATEGORY, HIERARCHY_PRODUCT_SUBCATEGORY, HIERARCHY_STORE, HIERARCHY_TIME, DIMENSION_DIM_CUSTOMER, DIMENSION_DIM_EMPLOYEE, DIMENSION_DIM_GEOGRAPHY, DIMENSION_DIM_PRODUCT));
        CATALOG.getOwnedElement().addAll(List.of(DIMENSION_DIM_PRODUCT_CATEGORY, DIMENSION_DIM_PRODUCT_SUB_CATEGORY, DIMENSION_DIM_STORE, DIMENSION_DIM_TIME, CUBE));
