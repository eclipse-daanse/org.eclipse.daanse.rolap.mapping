...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        // CT: writeback cube with Comments
        CubeCheck cubeTCheck = factory.createCubeCheck();
        cubeTCheck.setName("CubeCheck-CT");
        cubeTCheck.setDescription("Cube CT carries the text-writeback Comments measure");
        ...
        // V: VirtualCube exposing both measures
        CubeCheck cubeVCheck = factory.createCubeCheck();
        cubeVCheck.setName("CubeCheck-V");
        cubeVCheck.setDescription("Virtual Cube V references Amount and Comments");
