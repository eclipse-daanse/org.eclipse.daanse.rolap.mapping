...
/**
 * Provides a check suite for the KPI intro tutorial.
 * Checks that the catalog, cube, measure, and KPIs exist and are accessible.
 */
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        // Create KPI1 attribute check (value only)
        ...
        kpi1Check.setDescription("Check KPI 'Kpi1' with value only");
        ...
        kpi2Check.setDescription("Check KPI 'Kpi2' with parent reference");
        kpi2Check.setKpiName("Kpi2");
        kpi2Check.getKpiAttributeChecks().add(kpi2ValueCheck);

        // Create KPI3 attribute checks (value and display folder)
        ...
        KPIAttributeCheck kpi3DisplayFolderCheck = factory.createKPIAttributeCheck();
        kpi3DisplayFolderCheck.setAttributeType(KPIAttribute.DISPLAY_FOLDER);
        kpi3DisplayFolderCheck.setExpectedValue("theDisplayFolder\\otherDisplayFolder");

        // Create KPI3 check
        KPICheck kpi3Check = factory.createKPICheck();
        kpi3Check.setName("KPI Check for Kpi3");
        kpi3Check.setDescription("Check KPI 'Kpi3' with display folder");
        kpi3Check.setKpiName("Kpi3");
        kpi3Check.getKpiAttributeChecks().add(kpi3ValueCheck);
        kpi3Check.getKpiAttributeChecks().add(kpi3DisplayFolderCheck);
        ...
        databaseSchemaCheck.setDescription("Database Schema Check for Daanse Tutorial - KPI Intro");
        databaseSchemaCheck.getTableChecks().add(databaseTableCheckFact);

        // Create catalog check with cube check
        CatalogCheck catalogCheck = factory.createCatalogCheck();
        catalogCheck.setName("Daanse Tutorial - KPI Intro");
        catalogCheck.setDescription("Check that catalog 'Daanse Tutorial - KPI Intro' exists with its cubes");
        catalogCheck.setCatalogName("Daanse Tutorial - KPI Intro");
        ...
        connectionCheck.setName("Connection Check Daanse Tutorial - KPI Intro");
        connectionCheck.setDescription("Connection check for Daanse Tutorial - KPI Intro");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Daanse Tutorial - KPI Intro");
        suite.setDescription("Check suite for the Daanse Tutorial - KPI Intro");
