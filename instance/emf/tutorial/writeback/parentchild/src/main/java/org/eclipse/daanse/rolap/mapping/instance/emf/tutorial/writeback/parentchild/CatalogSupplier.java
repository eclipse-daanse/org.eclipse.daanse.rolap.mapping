...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(factSource, nodeSource, level, hierarchy, dimension, cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Minimal writeback example against a ParentChildHierarchy.");
