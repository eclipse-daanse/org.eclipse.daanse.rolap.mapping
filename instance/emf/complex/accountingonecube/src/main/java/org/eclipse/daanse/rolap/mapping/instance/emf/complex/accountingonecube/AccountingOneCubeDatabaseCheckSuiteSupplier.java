...
public class AccountingOneCubeDatabaseCheckSuiteSupplier implements DatabaseCheckSuiteSupplier {

    @Override
    public DatabaseCheckSuite get() {
        return new DatabaseCheckSuite(
                "Database Schema Check for AccountingOneCube",
                List.of(new DatabaseSchemaCheck("", List.of(
                        table("BOOKING",
                                col("ACCOUNT_KEY", "VARCHAR"),
                                col("AMOUNT_IST", "INTEGER"),
                                col("AMOUNT_PLAN", "INTEGER")),
                        table("BOOKINGWB",
                                col("USER", "VARCHAR"),
                                col("ACCOUNT_KEY", "VARCHAR"),
                                col("AMOUNT_IST", "INTEGER"),
