...
public class UnvisibleReferenceCubesTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.virtualcube.unvisiblereferencecubes";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new UnvisibleReferenceCubesDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new UnvisibleReferenceCubesDatabaseSupplier();
    }
