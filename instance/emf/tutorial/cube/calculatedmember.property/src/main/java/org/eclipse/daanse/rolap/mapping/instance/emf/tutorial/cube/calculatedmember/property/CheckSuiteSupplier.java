...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        calculatedMember1AttributeCheckFormat.setExpectedValue("$#,##0.00");
        ...
        cubeCheck.setName("CubeCheck-Cube CalculatedMember with properties");
        cubeCheck.setDescription("Check that cube 'Cube CalculatedMember with properties' exists with its measures");
        cubeCheck.setCubeName("Cube CalculatedMember with properties");
        ...
        catalogCheck.setName("\"Daanse Tutorial - Cube Calculated Member Property catalog check");
        catalogCheck.setDescription("Check that catalog 'Daanse Tutorial - Cube Calculated Member Property' exists with its cubes");
        ...
        connectionCheck.setName("Connection Check Daanse Tutorial - Cube Calculated Member Property");
        connectionCheck.setDescription("Connection check for \"Daanse Tutorial - Cube Calculated Member Property tutorial");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Daanse Tutorial - Cube Calculated Member Property");
        suite.setDescription("Check suite for the Daanse Tutorial - Cube Calculated Member Property");
