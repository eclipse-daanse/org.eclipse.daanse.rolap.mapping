...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(query, level1, level2, hierarchy1, hierarchy2, dimension1, cube1, role));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Access control with hierarchy-level grants");
    ...
    public TutorialDescription describe() {
        return new TutorialDescription(
                List.of(
                        new DocSection("Daanse Tutorial - Access Hierarchy Grant", catalogBody, 1, 0, 0, null, 0),
                        new DocSection("Database Schema", databaseSchemaBody, 1, 1, 0, databaseSchema, 3),
                        new DocSection("Query", queryBody, 1, 2, 0, query, 2),
                        new DocSection("Level2", level2Body, 1, 3, 0, level1, 0),
                        new DocSection("Hierarchy1 without hasAll Level1", hierarchy1Body, 1, 4, 0, hierarchy1, 0),
