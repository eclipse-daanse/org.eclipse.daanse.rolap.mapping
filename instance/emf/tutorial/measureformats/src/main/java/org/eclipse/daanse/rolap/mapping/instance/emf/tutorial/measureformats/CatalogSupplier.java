...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        catalog.setName("Minimal_Cube_With_Measures_Of_Different_formats");
        catalog.setDescription("Schema of a minimal cube containing the same measurement with two different formats");
