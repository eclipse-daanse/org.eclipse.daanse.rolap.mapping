...
public class SmallIntAsBooleanTypeTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.level.smallintasbooleantype";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new SmallIntAsBooleanTypeDatabaseSupplier();
    }
