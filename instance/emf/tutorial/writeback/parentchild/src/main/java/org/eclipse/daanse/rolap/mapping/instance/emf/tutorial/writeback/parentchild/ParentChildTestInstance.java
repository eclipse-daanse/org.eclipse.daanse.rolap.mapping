...
public class ParentChildTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.writeback.parentchild";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new ParentChildDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new ParentChildDatabaseSupplier();
    }
