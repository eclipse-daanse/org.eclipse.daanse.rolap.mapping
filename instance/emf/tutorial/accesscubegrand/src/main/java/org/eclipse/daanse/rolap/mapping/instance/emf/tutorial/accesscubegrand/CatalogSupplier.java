...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        schema.setName("Cube_with_access_all_dimension_cube1_access_only");
        schema.setDescription("Schema with access all dimension with cube1access only");
        ...
        documentation.setValue("Catalog with schema with access all dimension with cube1access only");
