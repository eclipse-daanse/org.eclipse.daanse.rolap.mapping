...
public class LevelsWithSameNamesTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tck.hierarchy.levelswithsamenames";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new LevelsWithSameNamesDatabaseSupplier();
    }
