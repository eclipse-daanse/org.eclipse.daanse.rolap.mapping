...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(query, levelMake, levelModel, levelPlant, levelVehicle, levelLicense, hierarchy, dimension));
        catalog.getOwnedElement().addAll(List.of(cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Hierarchy with unique key level name optimizations");
