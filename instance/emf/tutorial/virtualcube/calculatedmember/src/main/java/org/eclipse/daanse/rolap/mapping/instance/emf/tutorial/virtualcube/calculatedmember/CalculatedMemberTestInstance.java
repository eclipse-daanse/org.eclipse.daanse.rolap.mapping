...
public class CalculatedMemberTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.virtualcube.calculatedmember";
    }
    ...
    public DatabaseCheckSuiteSupplier dbCheckSupplier() {
        return new CalculatedMemberDatabaseCheckSuiteSupplier();
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new CalculatedMemberDatabaseSupplier();
    }
