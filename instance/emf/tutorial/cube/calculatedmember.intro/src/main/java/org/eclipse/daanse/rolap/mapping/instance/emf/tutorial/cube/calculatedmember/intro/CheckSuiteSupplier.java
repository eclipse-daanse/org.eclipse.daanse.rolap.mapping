...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        queryCheck1.setQuery("SELECT [Measures].[Measure1-Sum] ON COLUMNS FROM [Cube CalculatedMember]");
        ...
        queryCheck2.setQuery("SELECT [Measures].[Measure2-Count] ON COLUMNS FROM [Cube CalculatedMember]");
        ...
        queryCheck3.setQuery("SELECT [Measures].[Calculated Member 1] ON COLUMNS FROM [Cube CalculatedMember]");
        ...
        queryCheck4.setQuery("SELECT [Measures].[Calculated Member 2] ON COLUMNS FROM [Cube CalculatedMember]");
