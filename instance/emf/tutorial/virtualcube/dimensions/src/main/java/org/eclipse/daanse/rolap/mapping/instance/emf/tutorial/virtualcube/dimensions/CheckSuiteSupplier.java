...
/**
 * Provides a check suite for the virtual cube dimensions tutorial.
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    private static final String CATALOG_NAME = "Daanse Tutorial - Virtual Cube Dimensions";
    ...
    public OlapCheckSuite get() {
        ...
        databaseSchemaCheck.setDescription("Database Schema Check for virtual cube dimensions tutorial");
        ...
        connectionCheck.setDescription("Connection check for virtual cube dimensions tutorial");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Virtual Cube Dimensions Suite");
        suite.setDescription("Check suite for the virtual cube dimensions tutorial");
