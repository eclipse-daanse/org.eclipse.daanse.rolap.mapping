...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(query, hxL2Query, h1L1Query, h2L1Query, join1, join2, level1, level2));
        catalog.getOwnedElement().addAll(List.of(hierarchy1, level3, level4, hierarchy2, dimension, cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Drill-through action configuration");
