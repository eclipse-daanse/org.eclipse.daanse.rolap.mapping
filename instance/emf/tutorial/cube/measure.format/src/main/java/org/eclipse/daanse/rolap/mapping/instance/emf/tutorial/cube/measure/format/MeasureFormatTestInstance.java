...
/**
 * Auto-discovered test instance for tutorial.cube.measure.format — same
 * SUM measure under three different format strings (formatted-value
 * assertions: "63.00", "63", "63.").
 */
public class MeasureFormatTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.cube.measure.format";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureFormatDatabaseSupplier();
    }
