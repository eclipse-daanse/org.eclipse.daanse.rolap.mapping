 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.complex.csdl.catalog1;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public static final String CATALOG_NAME = "Sandbox";
...
/*
    ...
    <Property Name="SalesOrderNumber" Type="String" MaxLength="Max" Unicode="true"
    FixedLength="false">
    <bi:Property />
    </Property>
    ...
    <Property Name="CarrierTrackingNumber" Type="String" MaxLength="Max"
    Unicode="true" FixedLength="false">
    <bi:Property />
    </Property>
    <Property Name="CustomerPONumber" Type="String" MaxLength="Max" Unicode="true"
    FixedLength="false">
<bi:Property />
</Property>
...
<bi:Measure Caption="CaptionRolePlayingDimensionsDB"
ContextualNameRule="Context" Alignment="Right"
FormatString="&quot;$&quot;#,0.00;(&quot;$&quot;#,0.00);&quot;$&quot;#,0.00" Units="money"
SortDirection="Ascending" IsRightToLeft="true" IsSimpleMeasure="true" />
</Property>
<NavigationProperty Name="Customer2"
Relationship="Sandbox.FactInternetSales_DimCustomer_Customer2" FromRole="Sales"
ToRole="Customer2">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Customer_2"
Relationship="Sandbox.FactInternetSales_DimCustomer_Customer_2" FromRole="Sales2"
ToRole="Customer_2">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Time"
Relationship="Sandbox.FactInternetSales_DimTime_Time" FromRole="Sales3" ToRole="Time">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Time_2"
Relationship="Sandbox.FactInternetSales_DimTime_Time_2" FromRole="Sales4" ToRole="Time_2">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Time_3"
Relationship="Sandbox.FactInternetSales_DimTime_Time_3" FromRole="Sales5" ToRole="Time_3">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Store2"
Relationship="Sandbox.FactInternetSales_DimStore_Store2" FromRole="Sales6" ToRole="Store2">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Employee"
Relationship="Sandbox.FactInternetSales_DimEmployee_Employee" FromRole="Sales7"
ToRole="Employee">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<NavigationProperty Name="Product2"
Relationship="Sandbox.FactInternetSales_DimProduct_Product2" FromRole="FactInternetSales"
ToRole="Product2">
<bi:NavigationProperty ContextualNameRule="Merge" />
</NavigationProperty>
<bi:EntityType>
...
*/
    ...
    static {
        ...
        COLUMN_STATE_PROVINCE_CODE_GEOGRAPHY.setName("StateProvinceName");
        COLUMN_STATE_PROVINCE_CODE_GEOGRAPHY.setId("_column_geography_state_province_name");
        COLUMN_STATE_PROVINCE_CODE_GEOGRAPHY.setType(ColumnType.VARCHAR);
        ...
        COLUMN_SAFETY_STOCK_LEVEL_PRODUCT.setName("ReorderPoint");
        COLUMN_SAFETY_STOCK_LEVEL_PRODUCT.setId("_column_product_reorder_point");
        COLUMN_SAFETY_STOCK_LEVEL_PRODUCT.setType(ColumnType.INTEGER);
        ...
        //"ArabicDescription","HebrewDescription","ThaiDescription","StartDate","EndDate","Status","Subcategory"
        //VARCHAR,VARCHAR,VARCHAR,DATE,DATE,VARCHAR,VARCHAR
        ...
        COLUMN_PRODUCT_CATEGORY_KEY_PRODUCT_SUBCATEGORY.setId("_column_product_subcategory_product_subcategory_key");
        ...
        //"RowNumber","ProductSubcategoryKey","ProductSubcategoryAlternateKey","EnglishProductSubcategoryName","SpanishProductSubcategoryName","FrenchProductSubcategoryName","ProductCategoryKey"
        ...
        LEVEL_PRODUCT_SUBCATEGORY_SPANISH_PRODUCT_SUBCATEGORY_NAME.setId("_level_product_subcategory_row_number");
        ...
        DATABASE_SCHEMA.getTables()
                .addAll(List.of(TABLE_CUSTOMER, TABLE_EMPLOYEE, TABLE_GEOGRAPHY, TABLE_PRODUCT));
        ...
        HIERARCHY_PRODUCT_CATEGORY.setPrimaryKey(COLUMN_PRODUCT_CATEGORY_KEY_PRODUCT_CATEGORY);
        HIERARCHY_PRODUCT_CATEGORY.setQuery(TABLEQUERY_PRODUCT_CATEGORY);
        ...
        HIERARCHY_PRODUCT_SUBCATEGORY.setPrimaryKey(COLUMN_PRODUCT_SUBCATEGORY_KEY_PRODUCT_SUBCATEGORY);
        HIERARCHY_PRODUCT_SUBCATEGORY.setQuery(TABLEQUERY_PRODUCT_SUBCATEGORY);
        ...
        DIMENSION_DIM_CUSTOMER.getHierarchies().add(HIERARCHY_EMPLOYEE);
        ...
        //CONNECTOR_DIM_PRODUCT_CATEGORY.setForeignKey(COLUMN_PRODUCT_CATEGORY_KEY_FACT); TODO
        ...
        //CONNECTOR_DIM_PRODUCT_SUB_CATEGORY.setForeignKey(COLUMN_PRODUCT_SUBCATEGORY_KEY_FACT); //TODO
        ...
        //CONNECTOR_DIM_STORE.setForeignKey(COLUMN_STORE_KEY_FACT); //TODO
        ...
        //CONNECTOR_DIM_TIME.setForeignKey(COLUMN_TIME_KEY_FACT); //TODO
