...
/**
 * Provides a check suite for the writeback table tutorial.
...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    private static final String CATALOG_NAME = "Daanse Tutorial - Writeback Table";
    ...
    public OlapCheckSuite get() {
        ...
        // Create database table and column checks for FACT table
        ...
        databaseSchemaCheck.setDescription("Database Schema Check for writeback table tutorial");
        ...
        connectionCheck.setDescription("Connection check for writeback table tutorial");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Writeback Table Suite");
        suite.setDescription("Check suite for the writeback table tutorial");
