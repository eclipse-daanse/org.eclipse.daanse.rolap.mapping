...
@MappingInstance(kind = Kind.TUTORIAL, number = "2.5.3", source = Source.EMF, group = "Writeback") // NOSONAR
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        factwbValColumn.setId("_Factwb_VAL");
        ...
        factwbVal1Column.setId("_Factwb_VAL1");
        ...
        factwbL2Column.setId("_Factwb_L2");
        ...
        factwbIdColumn.setId("_Factwb_ID");
        ...
        factwbUserColumn.setId("_Factwb_USER");
        ...
        document(catalog, "Cube with writeback with fact as sql view", catalogBody, 1, 0, 0, false, 0);
        ...
        document(joinQuery, "joinQuery", joinBody, 1, 5, 0, true, 2);
