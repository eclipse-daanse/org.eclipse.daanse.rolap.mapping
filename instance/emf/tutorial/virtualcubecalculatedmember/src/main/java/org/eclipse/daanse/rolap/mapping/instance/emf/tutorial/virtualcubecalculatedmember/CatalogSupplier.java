 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.virtualcubecalculatedmember;
...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    private static final String CATALOG = "tutorial_24_VirtualCube_with_CalculatedMember";
    ...
    public CatalogMapping get() {
        ...
        dimensionConnector1.setOverrideDimensionName("Cube2Dimension1");
        dimensionConnector1.setForeignKey(keyColumn);
        dimensionConnector1.setDimension(dimension);
        ...
        schema.setName("Cube_with_virtual_cube_with_calculatedMember");
        schema.setDescription("Schema with virtual cube with calculatedMember");
