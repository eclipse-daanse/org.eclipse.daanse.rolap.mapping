...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        joinQueryElementTown.setSource(queryLevelTown);
        ...
        joinQueryElementCountry.setSource(queryLevelCountry);
        ...
        catalog.getOwnedElement().addAll(List.of(queryFact, queryLevelTown, queryLevelCountry, queryJoinTownToCountry, levelTown, levelCounty, hierarchy, dimension));
        catalog.getOwnedElement().addAll(List.of(cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Basic hierarchy with joined tables");
