...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(query, level1, level2, hierarchy1, hierarchy2, dimension1, dimension2, cube1));
        catalog.getOwnedElement().addAll(List.of(role));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Access control with dimension-level grants");
