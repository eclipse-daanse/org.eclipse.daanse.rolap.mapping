...
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public Catalog get() {
        ...
        hierarchy.setId("_hierarchy_countryHierarchy");
        ...
        cube.setId("_cube_with_ordinal_columns");
        cube.setQuery(query);
        ...
        document(catalog, "Daanse Tutorial - Levels with ordinal columns", introBody, 1, 0, 0, false, 0);
