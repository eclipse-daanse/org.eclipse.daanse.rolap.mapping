...
public class SumMeasureMappingImpl extends MeasureMappingImpl implements SumMeasureMapping{

    private ColumnMapping column;

    private SumMeasureMappingImpl(Builder builder) {
        super(builder);
    ...
    public static final class Builder extends MeasureMappingImpl.Builder {
        ...
        public SumMeasureMappingImpl build() {
            return new SumMeasureMappingImpl(this);
        }
