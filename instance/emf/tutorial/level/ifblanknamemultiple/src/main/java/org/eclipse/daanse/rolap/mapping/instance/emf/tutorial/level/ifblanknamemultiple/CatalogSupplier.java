...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(queryFact, queryLevel2Multiple, queryLevel3Multiple, queryLevel1Multiple, queryJoinRight, queryJoin, level1, level2));
        catalog.getOwnedElement().addAll(List.of(level3, hierarchyDimensionMembersHiddenMultipleLevels, dimensionMembersHiddenMultipleLevels, cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Multiple levels handling blank names");
