...
public class CatalogSupplier implements CatalogMappingSupplier, TutorialDescriptionSupplier {
    ...
    public Catalog get() {
        ...
        catalog.getOwnedElement().addAll(List.of(query, levelYears, levelQuarters, levelMonths, levelWeek, levelDay, hierarchy, dimension));
        catalog.getOwnedElement().addAll(List.of(cube));

        Descriptions.describe(catalog, CwmHelper.TYPE_DOCUMENTATION, null, "Time dimension configuration");
