...
/**
 * Auto-discovered test instance for tutorial.cube.measure.aggregator.percentile.
 */
public class MeasureAggregatorPercentileTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.measure.aggregator.percentile"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureAggregatorPercentileDatabaseSupplier();
    }
