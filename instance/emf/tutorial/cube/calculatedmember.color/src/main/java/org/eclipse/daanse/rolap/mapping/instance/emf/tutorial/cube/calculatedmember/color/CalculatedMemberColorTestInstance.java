...
/**
 * Auto-discovered test instance for tutorial.cube.calculatedmember.color.
 */
public class CalculatedMemberColorTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.calculatedmember.color"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new CalculatedMemberColorDatabaseSupplier();
    }
