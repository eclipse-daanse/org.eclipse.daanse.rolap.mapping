 ...
 *
 */
package org.eclipse.daanse.rolap.mapping.instance.emf.tutorial.hierarchy.levelifparentsname;
...
@MappingInstance(kind = Kind.TUTORIAL, number = "2.16.4", source = Source.EMF, group = "Hierarchy") // NOSONAR
public class CatalogSupplier implements CatalogMappingSupplier {
    ...
    public CatalogMapping get() {
        ...
        catalog.setName("Minimal Single Hierarchy Hidden Members with IfParentsName");
        ...
        document(hierarchyDimensionMembersHiddenIfParentsNameLevel2, "Level1", level2Body, 1, 8, 0, true, 2);
