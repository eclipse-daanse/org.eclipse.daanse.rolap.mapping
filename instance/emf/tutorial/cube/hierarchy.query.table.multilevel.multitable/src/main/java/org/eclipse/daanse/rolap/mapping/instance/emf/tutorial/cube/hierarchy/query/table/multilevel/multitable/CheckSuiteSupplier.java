...
public class CheckSuiteSupplier implements OlapCheckSuiteSupplier {
    ...
    public OlapCheckSuite get() {
        ...
        catalogCheck.setName("Daanse Tutorial - Hierarchy Query Table Multilevel Multitable");
        catalogCheck.setDescription("Check that catalog 'Daanse Tutorial - Hierarchy Query Table Multilevel Multitable' exists with its cubes");
        ...
        connectionCheck.setName("Connection Check Daanse Tutorial - Hierarchy Query Table Multilevel Multitable");
        connectionCheck.setDescription("Connection check for Daanse Tutorial - Hierarchy Query Table Multilevel Multitable");
        connectionCheck.getCatalogChecks().add(catalogCheck);

        // Create suite containing the connection check
        OlapCheckSuite suite = factory.createOlapCheckSuite();
        suite.setName("Daanse Tutorial - Hierarchy Query Table Multilevel Multitable");
        suite.setDescription("Check suite for the Daanse Tutorial - Hierarchy Query Table Multilevel Multitable");
