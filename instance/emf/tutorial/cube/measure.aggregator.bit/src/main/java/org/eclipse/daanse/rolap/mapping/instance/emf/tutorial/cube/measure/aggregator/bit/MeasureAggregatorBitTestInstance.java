...
/**
 * Auto-discovered test instance for tutorial.cube.measure.aggregator.bit.
 */
public class MeasureAggregatorBitTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.measure.aggregator.bit"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureAggregatorBitDatabaseSupplier();
    }
