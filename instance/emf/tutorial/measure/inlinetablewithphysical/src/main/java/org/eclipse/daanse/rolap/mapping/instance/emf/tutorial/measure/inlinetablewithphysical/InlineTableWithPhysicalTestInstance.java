...
public class InlineTableWithPhysicalTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.measure.inlinetablewithphysical";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new InlineTableWithPhysicalDatabaseSupplier();
    }
