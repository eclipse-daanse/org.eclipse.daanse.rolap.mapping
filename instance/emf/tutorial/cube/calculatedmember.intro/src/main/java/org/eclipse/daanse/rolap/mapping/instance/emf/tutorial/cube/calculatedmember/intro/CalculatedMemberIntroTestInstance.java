...
/**
 * Auto-discovered test instance for tutorial.cube.calculatedmember.intro.
 */
public class CalculatedMemberIntroTestInstance implements CatalogTestInstance {

    @Override
    public String name() { return "tutorial.cube.calculatedmember.intro"; }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new CalculatedMemberIntroDatabaseSupplier();
    }
