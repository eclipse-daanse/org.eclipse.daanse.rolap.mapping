...
/**
 * Auto-discovered test instance for tutorial.cube.measure.datatype — two
 * SUM measures over the same column declared with Integer vs Numeric
 * datatypes, both summing to 63.
 */
public class MeasureDatatypeTestInstance implements CatalogTestInstance {

    @Override
    public String name() {
        return "tutorial.cube.measure.datatype";
    }
    ...
    public DatabaseSupplier databaseSupplier() {
        return new MeasureDatatypeDatabaseSupplier();
    }
